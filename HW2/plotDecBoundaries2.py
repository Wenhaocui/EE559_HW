...
def plotDecBoundaries(training, label_train, sample_mean, cla):
    ...
    if cla == 1:
        ...
        plt.plot(training[label_train == 3, 0],training[label_train == 3, 1], 'go')
    elif cla == 2:
        plt.plot(training[label_train == 2, 0],training[label_train == 2, 1], 'rx')
        plt.plot(training[label_train == 1, 0],training[label_train == 1, 1], 'go')
        plt.plot(training[label_train == 3, 0],training[label_train == 3, 1], 'go')
    elif cla == 3:
        plt.plot(training[label_train == 3, 0],training[label_train == 3, 1], 'rx')
        plt.plot(training[label_train == 2, 0],training[label_train == 2, 1], 'go')
        plt.plot(training[label_train == 1, 0],training[label_train == 1, 1], 'go')

    # include legend for training data
    if cla == 1:
        l = plt.legend(('Class 1', 'Not Class 1'), loc=2)
    elif cla == 2:
        l = plt.legend(('Class 2', 'Not Class 2'), loc=2)
    elif cla == 3:
        l = plt.legend(('Class 3', 'Not Class 3'), loc=2)
    ...
    # else:
    #     l1 = plt.legend([m1,m2], ['Class 1 Mean', 'Not Class 1 Mean'], loc=4)
    if cla == 1:
        l1 = plt.legend([m1,m2], ['Class 1 Mean', 'Not Class 1 Mean'], loc=4)
    elif cla == 2:
        l1 = plt.legend([m1,m2], ['Class 2 Mean', 'Not Class 2 Mean'], loc=4)
    elif cla == 3:
       l1 = plt.legend([m1,m2], ['Class 3 Mean', 'Not Class 3 Mean'], loc=4)
